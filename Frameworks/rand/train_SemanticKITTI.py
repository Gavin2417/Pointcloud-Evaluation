...
parser.add_argument('--max_epoch', type=int, default=30, help='Epoch to run [default: 100]')
...
class Trainer:
    def __init__(self):
        ...
        console.setLevel(logging.INFO)  # or DEBUG if you want
        ...
        # Loss Function
        class_weights = torch.from_numpy(train_dataset.get_class_weight()).float().view(cfg.num_classes).cuda() # change code to this can run
    ...
    def train(self):
        for epoch in range(self.start_epoch, FLAGS.max_epoch):
            ...
            if mean_iou > self.highest_val_iou:
                ...
                checkpoint_file = os.path.join(self.log_dir, 'checkpoint_slope_final.tar')
